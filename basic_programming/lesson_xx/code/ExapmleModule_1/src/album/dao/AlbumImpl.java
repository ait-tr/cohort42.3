...
public class AlbumImpl implements Album {
    ...
    // sort photos by date and then by id
    ...
    public boolean addPhoto(Photo photo) {
        ...
        // shift array from index to right on one position
        // destPos: start position, length: length the tail of array
        System.arraycopy(photos, index, photos, index + 1, size - index);
        photos[index] = photo; // insert photo on position=index
        size++; //
        return true;
    }
