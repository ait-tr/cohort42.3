...
//        }
    ...
    void removePhotoTest() {
        ...
        // find removed photo
        Assertions.assertNull(album.getPhotoFromAlbum(3, 1));
    ...
    void getPhotoFromAlbumTest() {
        ...
        Assertions.assertNull(album.getPhotoFromAlbum(1,3)); // find absent photo
    }

    @Test
    void getAllPhotoFromAlbumTest() {
        Photo[] expected = {ph[3], ph[4], ph[5]}; //
        Photo[] actual = album.getAllPhotoFromAlbum(2); // albumId = 2
